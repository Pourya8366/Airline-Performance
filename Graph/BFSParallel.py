...
parser.add_argument("--startnode")
parser.add_argument("--endnode")
...
class BFSParallel(MRJob):
    ...
    def configure_args(self):
        super(BFSParallel, self).configure_args()
        self.add_passthru_arg("--startnode", default="LAX", type=str)
        self.add_passthru_arg("--endnode", default="LGA", type=str)
